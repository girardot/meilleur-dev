...
public class IsoContestTest extends AbstractTest {
    ...
    @Test
    @Parameters({
            "src/test/resources/other.shop/input1.txt,src/test/resources/other.shop/output1.txt",
            "src/test/resources/other.shop/input2.txt,src/test/resources/other.shop/output2.txt"})
    public void should_test_exo(String inputFileName, String outputFileName) throws Exception {
        // Given
        System.setIn(new FileInputStream(inputFileName));

        // When
        other.shop.IsoContest.main(null);
