...
public class IsoContestTest extends AbstractTest {
    ...
    @Test
    @Parameters({
            "src/test/resources/cctv/input1.txt,src/test/resources/cctv/output1.txt",
            "src/test/resources/cctv/input2.txt,src/test/resources/cctv/output2.txt"})
    public void should_test_exo(String inputFileName, String outputFileName) throws Exception {
        // Given
        System.setIn(new FileInputStream(inputFileName));

        // When
        cctv.IsoContest.main(null);
