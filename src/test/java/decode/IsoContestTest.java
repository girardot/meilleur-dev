...
public class IsoContestTest extends AbstractTest {
    ...
    @Test
    @Parameters({
            "src/test/resources/decode/input1.txt,src/test/resources/decode/output1.txt",
            "src/test/resources/decode/input2.txt,src/test/resources/decode/output2.txt"})
    public void should_test_exo(String inputFileName, String outputFileName) throws Exception {
        // Given
        System.setIn(new FileInputStream(inputFileName));

        // When
        decode.IsoContest.main(null);
