...
Dans ce challenge, l'objectif est de déterminer la somme qu'a un joueur à la fin d'une partie de mars2015.poker. Le joueur dispose d'une somme initiale. À chaque tour, le joueur mise un montant X. Puis il gagne un montant Y pouvant être positif ou nul. Le bilan pour chaque tour est donc -X+Y.
