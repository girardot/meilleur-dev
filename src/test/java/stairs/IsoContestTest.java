...
public class IsoContestTest extends AbstractTest {
    ...
    @Test
    @Parameters({
            "src/test/resources/stairs/input1.txt,src/test/resources/stairs/output1.txt",
            "src/test/resources/stairs/input2.txt,src/test/resources/stairs/output2.txt"})
    public void should_test_exo(String inputFileName, String outputFileName) throws Exception {
        // Given
        System.setIn(new FileInputStream(inputFileName));

        // When
        stairs.IsoContest.main(null);
